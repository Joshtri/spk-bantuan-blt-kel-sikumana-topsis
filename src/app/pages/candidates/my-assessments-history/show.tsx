...
import { useGo, useNavigation, useOne, useParsed } from "@refinedev/core";
...
export default function AssessmentHistoryShowPage() {
  const { id } = useParsed();
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Button
        variant="ghost"
        size="sm"
        onPress={() => go({ to: `/history-penilaian`, type: "push" })}
      >
